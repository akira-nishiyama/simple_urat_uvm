...
#  simple_uart_uvm_SIM_FILES        - simulation files. Compile required.
...
file(GLOB simple_uart_uvm_SIM_FILES ${CMAKE_CURRENT_LIST_DIR}/src/*.sv)
...
#message("simple_uart_uvm_INCLUDE_DIRS:${simple_uart_uvm_INCLUDE_DIRS}")
#message("simple_uart_uvm_TESTBENCH_FILES:${simple_uart_uvm_TESTBENCH_FILES}")
